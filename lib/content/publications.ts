// Content for the Publications page. The page component renders directly
// from these exports, and the search index is generated from this same
// file (see scripts/generate-search-index.mjs).
...
export const publicScholarshipByYear: Record<number, Array<{
  title: string
  publication: string
  link: string
}>> = {
